...
object ClearConfirmation {
    ...
    const val SERVICE_CENTER_NOTICE: String =
        "제조사 서비스센터가 특정 오류코드를 삭제한 뒤 운행하도록 안내했다면, " +
            "삭제가 보호·주행 제한 상태를 해제해 이동 또는 운행을 이어가기 위한 절차일 수 있습니다.\n" +
            "센터가 안내한 대상 코드, 재시동 방법, 운행 조건과 후속 점검 일정을 우선해서 따르세요. " +
            "삭제 후 앱이 자동으로 다시 읽은 결과도 함께 확인할 수 있습니다."
