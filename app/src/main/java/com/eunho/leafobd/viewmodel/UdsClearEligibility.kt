...
object UdsClearConfirmation {
    ...
    const val SERVICE_CENTER_NOTICE: String =
        "제조사 서비스센터가 특정 ECU 오류를 삭제한 뒤 운행하도록 안내했다면, " +
            "삭제가 차량의 보호·주행 제한 상태를 해제하는 데 필요한 절차일 수 있습니다.\n\n" +
            "센터가 안내한 ECU 또는 코드, 재시동 방법, 운행 조건과 후속 점검 일정을 그대로 따르세요. " +
            "이 앱은 삭제 직후 코드를 다시 읽어 결과를 비교합니다."
